...
export interface ApiAccessibilityAccessAccessibilityAccess
  extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::accessibility-access.accessibility-access'
    > &
      Schema.Attribute.Private;
...
export interface ApiAccessibilityNeedAccessibilityNeed
  ...
  attributes: {
    accessibility_accesses: Schema.Attribute.Relation<
      'manyToMany',
      'api::accessibility-access.accessibility-access'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    >;
    NameOfNeed: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    EventPicture: Schema.Attribute.Media<'images' | 'files' | 'videos', true> &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    EventType: Schema.Attribute.Enumeration<
      ['Concert', 'Festival', 'Conference', 'Sports']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
    ...
    Languages: Schema.Attribute.Enumeration<
      ['English', 'Spanish', 'German', 'Italian', 'Mandarin', 'Arabic']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
    ...
    MaxCapacity: Schema.Attribute.BigInteger &
      Schema.Attribute.Required &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ContactInfo: Schema.Attribute.Component<'first-name.contact-info', false> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    localizations: Schema.Attribute.Relation<
      ...
      'api::location.location'
    >;
    LocationOverview: Schema.Attribute.Media<
...
export interface ApiOrganizerOrganizer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Media: Schema.Attribute.Media<
      ...
      true
    >;
    NameOfOrganizer: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiTicketTicket extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required;
    TicketType: Schema.Attribute.Enumeration<['VIP', 'Discounted', 'General']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::accessibility-access.accessibility-access': ApiAccessibilityAccessAccessibilityAccess;
